...
Stock,Bin,InspectionPeriod,Guid,TaxRate,Specification,Comment1,ParentGuid,POItemConfirmer,ItemReceiveType,IsFOItem,LotNumberAssign)
                                            VALUES
	                                            (
	                                            '" + dtPO.Rows[i]["PONumber"].ToString() + "','" + dr["VendorNumber"].ToString() + "', '" + dr["VendorName"].ToString() + "', '" + dr["VendorNumber"].ToString() + "', '" + dr["VendorName"].ToString() + "', '" + dr["ItemNumber"].ToString() + "', '" + dr["ItemDescription"].ToString() + "','" + dr["ItemUM"].ToString() + "', '" + dr["BuyerID"].ToString() + "', '" + UserName + "','" + dr["SupervisorID"].ToString() + "','" + DateTime.Now.AddDays(12).ToString("MMddyy") + "','" + dr["ForeignOrderNumber"].ToString() + "',2,'', ''," + Math.Round(Convert.ToDouble(dr["PurchasePrice"]) / 1.13, 9) + "," + Convert.ToDouble(dr["PurchasePrice"]) + ",'P',4, '" + deliveryDate + "','" + DateTime.Now.AddDays(12).ToString("MMddyy") + "'," + Convert.ToDouble(dr["Quantity"]) + ",'" + itemKeeper.Trim() + "','" + ItemInfoList[1] + "','" + ItemInfoList[2] + "','" + ItemInfoList[0] + "','" + Guid.NewGuid().ToString() + "',0,'" + dr["SpecificationDescription"].ToString() + "','" + dr["Requirements"].ToString() + "','" + dr["ParentGuid"].ToString() + "','"+"P08"+"','"+PurchaseUser.ItemReceiveType+"',1,'C')";
                            }
                            else
                            {
                                sqlInsert = @"INSERT INTO PurchaseOrderRecordByCMF (
                                            ...
                                            VALUES (
	                                            '" + dtPO.Rows[i]["PONumber"].ToString() + "','" + dr["VendorNumber"].ToString() + "', '" + dr["VendorName"].ToString() + "', '" + dr["VendorNumber"].ToString() + "', '" + dr["VendorName"].ToString() + "', '" + dr["ItemNumber"].ToString() + "', '" + dr["ItemDescription"].ToString() + "','" + dr["ItemUM"].ToString() + "', '" + dr["BuyerID"].ToString() + "', '" + UserName + "','" + dr["SupervisorID"].ToString() + "','" + DateTime.Now.AddDays(12).ToString("MMddyy") + "','" + dr["ForeignOrderNumber"].ToString() + "',2,'', ''," + Math.Round(Convert.ToDouble(dr["PurchasePrice"]) / 1.13, 9) + "," + Convert.ToDouble(dr["PurchasePrice"]) + ",'P',4, '" + DateTime.Now.AddDays(Convert.ToInt32(deliveryDate)).ToString("MMddyy") + "','" + DateTime.Now.AddDays(12).ToString("MMddyy") + "'," + Convert.ToDouble(dr["Quantity"]) + ",'" + itemKeeper.Trim() + "','" + ItemInfoList[1] + "','" + ItemInfoList[2] + "','" + ItemInfoList[0] + "','" + Guid.NewGuid().ToString() + "',0,'" + dr["SpecificationDescription"].ToString() + "','" + dr["Requirements"].ToString() + "','" + dr["ParentGuid"].ToString() + "','"+ "P08" + "','" + PurchaseUser.ItemReceiveType + "',1,'C')";
                            }
