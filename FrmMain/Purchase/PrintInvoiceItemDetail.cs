...
{
    public partial class PrintInvoiceItemDetail : Office2007Form
    {
        List<string> VendorList = new List<string>();
        private GridppReport Report = new GridppReport();
        DataTable dt = new DataTable();
        string InvoiceNumber = string.Empty;
        public PrintInvoiceItemDetail(List<string> list,DataTable dtInvoice,string invoiceNumber,string templatePah)
        {
            InitializeComponent();
