...
namespace Global
{
    ...
    {
   //     public static readonly string FSDBConnstr = "server=192.168.8.177;database=FSDB;uid=sa;pwd=ReyoungDB1!";
   ...
   //     public static readonly string oledbconnstrFSDB = "Provider=SQLOLEDB.1;Persist Security Info=True;Use Procedure for Prepare=1;Auto Translate=false;Data Source=192.168.8.11;Initial Catalog=fsdb;User ID=xym;Password=xym-123";
        ...
        */
        ...
        //测试服务器连接信息
        public static readonly string connstrFSDBTR = "server=192.168.8.51;database=FSDBTR;uid=sa;pwd=ERPtest321";
        public static readonly string oledbconnstrFSDBTR = "Provider=SQLOLEDB.1;Password=ERPtest321;Persist Security Info=True;User ID=sa;Initial Catalog=FSDBTR;Data Source=192.168.8.51;Use Procedure for Prepare=1;Auto Translate=false;";
